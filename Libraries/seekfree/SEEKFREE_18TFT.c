...
void lcd_init(void)
{	
    (void)spi_init(TFT_SPIN, TFT_CS, TFT_SCL, TFT_SDA, TFT_SDA_IN, 0, 20*1000*1000);//硬件SPI初始化
    
    gpio_init(BL_PIN,GPO,1,NOPULL);
    gpio_init(DC_PIN,GPO,0,NOPULL);
    gpio_init(REST_PIN,GPO,0,NOPULL);
