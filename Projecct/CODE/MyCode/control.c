...
void SteerControl(void)
{
	...
	*/
	...
	SteerAngle = limit1(angle/10,_SteerDutyMax_);    // 舵机限幅
	
	//ftm_pwm_duty(FTM2,FTM_CH1,_SteerCenter_ + SteerAngle);
	ctimer_pwm_duty(TIMER4_PWMCH0_A6, _SteerCenter_ + SteerAngle);
}
...
//	sk3 = (_INT8U_)limit1(MyAbs(CorrectOffset/10)*(20+sk0)/20,50);	// 面积与速度
//	
//	speed_position = (_INT8U_)limit1(sk1+sk2+sk3,_SpeedParameter_);		// 系数合成,提前减速效果
//	
